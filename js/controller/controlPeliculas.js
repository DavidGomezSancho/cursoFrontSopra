function iniciarPrograma(){
    ...
    document.addEventListener("keydown", (e) => {
        var codigo = document.getElementById("cod-id");
...
function cargarPeliculaEnFormulario(peli){
    ...
    document.getElementById("genero").options[valorElementoForm.selectedIndex].text = peli.genero;
    document.getElementById("fechPublicacion").valueAsDate = peli.fecha;
...
function mostrarPeliculasEnTabla(){
    ...
    var tBody = document.getElementById("vistaTablaPeliculasBody");
...
function guardarPeliculaButton(){
    ...
    peli.genero = genero.options[genero.selectedIndex].text;
    peli.fecha = document.getElementById("fechPublicacion").valueAsDate;
